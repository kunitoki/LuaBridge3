...
#if LUABRIDGE_HAS_EXCEPTIONS
namespace {
struct ThrowingConstructorClass : public std::enable_shared_from_this<ThrowingConstructorClass>
{
...
TEST_F(ClassTests, ThrowingPrimaryConstructors)
{
    luabridge::getGlobalNamespace(L)
        .beginClass<ThrowingConstructorClass>("ThrowingConstructorClass")
        .addConstructor<void(*)()>()
        .endClass();

    EXPECT_ANY_THROW(runLua("result = ThrowingConstructorClass()"));
}

TEST_F(ClassTests, ThrowingPlacementConstructors)
{
    luabridge::getGlobalNamespace(L)
        .beginClass<ThrowingConstructorClass>("ThrowingConstructorClass")
        ...
        {
            throw std::runtime_error("Throwing during construction");
            return new(ptr) ThrowingConstructorClass();
        })
        .endClass();
    ...
    luabridge::getGlobalNamespace(L)
        .beginClass<ThrowingConstructorClass>("ThrowingConstructorClass2")
        .addConstructor([](void* ptr)
        {
            return new(ptr) ThrowingConstructorClass();
        })
    ...
    EXPECT_ANY_THROW(runLua("result = ThrowingConstructorClass2()"));
}

TEST_F(ClassTests, ThrowingContainerPrimaryConstructors)
{
    luabridge::getGlobalNamespace(L)
        .beginClass<ThrowingConstructorClass>("ThrowingConstructorClass")
        .addConstructorFrom<std::shared_ptr<ThrowingConstructorClass>, void(*)()>()
        .endClass();

    EXPECT_ANY_THROW(runLua("result = ThrowingConstructorClass()"));
}

TEST_F(ClassTests, ThrowingContainerPlacementConstructors)
{
    luabridge::getGlobalNamespace(L)
        .beginClass<ThrowingConstructorClass>("ThrowingConstructorClass")
        .addConstructorFrom<std::shared_ptr<ThrowingConstructorClass>>([]
        {
            throw std::runtime_error("Throwing during construction");
            return std::make_shared<ThrowingConstructorClass>();
        })
        .endClass();
...
TEST_F(ClassTests, ThrowingFactoryConstructors)
{
    luabridge::getGlobalNamespace(L)
        .beginClass<ThrowingConstructorClass>("ThrowingConstructorClass")
        .addFactory(
            +[]() -> ThrowingConstructorClass* {
                throw std::runtime_error("Throwing during construction");
                return new ThrowingConstructorClass(); },
            +[](ThrowingConstructorClass* x) { delete x; })                    
        .endClass();
